...
from gear_sonic.envs.manager_env.robots import g1, h2, booster_t1_29dof as t1
...
class ModularTrackingEnvCfg(ManagerBasedRLEnvCfg):
    ...
    def override_settings(self):
        ...
        robot_mapping = {
            ...
            "booster_t1_29dof": {
                "robot_cfg": t1.T1_CFG,
                "action_scale": t1.T1_ACTION_SCALE,
                "isaaclab_to_mujoco_mapping": t1.T1_ISAACLAB_TO_MUJOCO_MAPPING,
            },
        }
